...
<div class="modalAddPhotoContainer">
				<a href="/FrontEnd/index.html#arrow-left" title="#">
				...
				<div class="modalAddPhotoAjouterPhotoContainer">
					<div class="modalAddPhotoAjouterPhoto">
						<label for="fileInput" class="custom-file-upload">+ Ajouter photo</label>
						  ...
						  <div id="imageContainer"></div>
								...
								<!--<h4>+ Ajouter photo</h4>-->
					  <p class="ajout">jpg.png : 4mo max</p> 
								</div>
				</div>
...
/*var container = document.querySelector('.modalAddPhotoAjouterPhotoContainer');
...
addPhotoButton.addEventListener('click', function() {
  ...
  let titre = document.getElementById('Titre-photo').value;
  let categorie = document.getElementById('categorie-photo').value;


  const modalPhotoContainer = document.createElement('div');
  modalPhotoContainer.className = 'modal-photo';
  //modalPhotoContainer.innerHTML = '<img src="' + URL.createObjectURL(image) + '" alt="Uploaded Image">';
  ...
  //suppression de l'image de son emplacement d'origine (téléchargement)
  imageInput.value = '';
});